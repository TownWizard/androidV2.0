...
import com.mlsdev.andoid.townwizard.ui.adapter.FacebookPlacesAdapter;
...
public class FacebookPlaceActivity extends ListActivity {
	...
	sFb.authorize(this, new String[] { "publish_stream", "publish_checkins", "friends_checkins", "user_checkins" },
		new DialogListener() {
		    @Override
