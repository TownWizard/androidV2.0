...
public class WebActivity extends Activity {
	...
	File photo = new File(Environment.getExternalStorageDirectory(), Long.toString(System
		.currentTimeMillis()));
	...
	startActivityForResult(Intent.createChooser(intent, "Select Picture"), sGALLERY);
    }
